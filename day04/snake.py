...
score_rect.center = (WINDOW_WIDTH//10, WINDOW_HEIGHT//10)
...
# Update HUD
score_text = font.render (f"Score {score}" + str(score), True, GREEN, DARKRED)
...
pygame.draw.rect(display_surface, DARKRED, head_coord)
